...
bool check_name(const std::string& _str, const std::string& _subject, const int& _minLength, const int& _maxLength);	// проверки строки на пустоту, минимальную/максимальную длину
...
bool QuestionYN(const std::string& _str);	// вопрос с двумя вариантами ответа (да/нет)